# Remove the qBittorrent Dedicated Tunnel
...
The account therefore holds four devices — Joyful Badger (this Mac's app), Free
Deer (dino), Dear Bear (unidentified), Proper Gecko (this Mac's idle qbt tunnel)
— of which the last is pure waste.
